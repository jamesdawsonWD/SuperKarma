...
/**
 * @title Time Locked Executor Contract, inherited by SuperKarma Governance Executors
...
contract ExecutorWithTimelock is IExecutorWithTimelock {
     ...
     **/
    function isProposalOverGracePeriod(ISuperKarmaGovernance governance, uint256 proposalId)
        external
        view
        override
        returns (bool)
